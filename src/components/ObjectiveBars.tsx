...
/**
 * 「整场刚好装下」时，画布宽度覆盖的场地跨度（米）。缩放基准由它反推：
 * `基准 px/m = 画布宽 / 这个数`，于是 k=1 恒等于「刚装下」那一档，
 * 与沙盘容器多大无关 —— 拉大窗口时沙盘和血条一起变大，比例不变；
 * 只有用户真的滚轮缩放，k 才动。实测 990px 宽的沙盘装下 36.1 m。
 */
const FIT_SPAN_M = 36.1;
