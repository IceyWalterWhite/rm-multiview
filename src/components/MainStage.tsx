...
export function MainStage({ main, quality, titleFallback, matchTitle, messages, showDanmaku, cheerSlot, onSignatureExpired, syncEngine, syncOn, onToggleSync, syncTrim, onSyncTrim, onRecalibrate }: {
  main: StreamView;
